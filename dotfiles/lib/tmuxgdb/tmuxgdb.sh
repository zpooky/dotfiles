...
echo "      - $HOME/dotfiles/lib/tmuxgdb/sub.sh  \"${FIFO_pipe}\" history_TTY stack_TTY variables_TTY" >>"${TEAMCIL_yaml}"
...
echo "      - $HOME/dotfiles/lib/tmuxgdb/sub.sh  \"${FIFO_pipe}\" breakpointz_TTY registers_TTY" >>"${TEAMCIL_yaml}"
